...
\begin{frame}{Sinyal}
	...
	\begin{multicols}{2}
		\begin{figure}
			\includegraphics[width=0.5\linewidth]{00.pengantar/00.sinyal_suara}
			\caption{Sinyal suara, 1 variabel (tekanan suara terhadap waktu), \textit{one-dimensional}}
		\end{figure}
		\begin{figure}
			\includegraphics[width=0.7\linewidth]{00.pengantar/00.sinyal_gambar}
...
\begin{frame}{Sinyal waktu diskret dan kontinu}
	\begin{multicols}{2}
		...
		\begin{figure}
			\centering
			\includegraphics[height=0.65\textheight]{00.pengantar/00.representasi_grafis_dari_sinyal_waktu_kontinu_dan_diskret}
...
\begin{frame}{Contoh sinyal waktu diskret}
	\begin{figure}
		\includegraphics[height=0.7\textheight]{00.pengantar/00.sinyal_waktu_diskret}
...
\begin{frame}{Contoh sinyal waktu kontinu}
	...
	\begin{figure}
		\includegraphics[height=0.7\textheight]{00.pengantar/00.sinyal_waktu_kontinu}
...
\begin{frame}{Contoh sistem yang memproses sinyal multi-dimensional}
	\begin{multicols}{2}
		\begin{figure}
			\centering
			\includegraphics[height=0.65\textheight]{gambar/00.pengantar/00.foto_jalan_berawan}
		...
		\begin{figure}
			\centering
			\includegraphics[height=0.65\textheight]{gambar/00.pengantar/00.foto_jalan_awan_hilang}
