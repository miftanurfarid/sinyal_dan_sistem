...
\begin{frame}{Karakteristik Sistem}
	\begin{figure}
		\centering
		\includegraphics[height=0.8\textheight]{gambar/02.sistem/02.slide_13}
	\end{figure}
\end{frame}
...
\begin{frame}{Karakteristik Sistem}
	\begin{figure}
		\centering
		\includegraphics[height=0.8\textheight]{gambar/02.sistem/02.slide_14}
	\end{figure}
\end{frame}
...
\begin{frame}{Karakteristik Sistem}
	\begin{figure}
		\centering
		\includegraphics[height=0.8\textheight]{gambar/02.sistem/02.slide_15}
	\end{figure}
\end{frame}
\end{document}
